...
export class InjectTwoLegged {
    ...
    public async apply(lego: DroppedLego, connection: Connection, oldLego: DroppedLego | undefined = undefined): Promise<{ connections: Connection[], droppedLegos: DroppedLego[], operation: Operation }> {
        ...
        const externalConnections = this.connections.filter(conn => !(connection.equals(conn)));
