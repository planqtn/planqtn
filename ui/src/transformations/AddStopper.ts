...
export class AddStopper {
    ...
    public apply(targetLego: DroppedLego, targetLegIndex: number, stopperLego: DroppedLego): { connections: Connection[], droppedLegos: DroppedLego[], operation: Operation } {
        ...
        const isLegConnected = this.connections.some(conn =>
            ...
            (conn.to.legoId === targetLego.instanceId && conn.to.legIndex === targetLegIndex)
        );
        ...
        const existingStopperIndex = this.droppedLegos.findIndex(l => l.instanceId === stopperLego.instanceId);
        ...
        return {
            ...
            operation: {
                ...
                data: {
                    ...
                    legosToUpdate: existingStopperIndex !== -1 ? [{
